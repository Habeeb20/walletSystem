...
/**
 * @swagger
 * /api/tv/buy-tv-subscription:
 *   post:
 *     summary: Purchase a TV subscription plan using wallet balance
 *     description: >
 *       coded encodes the provider as its prefix (e.g. "dstv_compact-1month").
 *       Validates the smartcard/decoder number via MCD, deducts price from wallet,
 *       calls MCD's /tv endpoint, and rolls back on failure.
 ...
 *           schema:
 *             type: object
 *             required: [coded, number, price]
 *             properties:
 *               coded:
 *                 type: string
 *                 description: Provider-prefixed plan code, e.g. "dstv_compact-1month"
 *                 example: "dstv_compact-1month"
 *               number:
 *                 type: string
 *                 description: Smartcard/decoder number
 *                 example: "1234567890"
 *               price:
 *                 type: number
 *                 example: 9000
 ...
 *       500:
 *         description: TV subscription failed
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
