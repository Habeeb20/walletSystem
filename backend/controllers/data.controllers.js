...
/**
 * @swagger
 * /api/airtime/buy-data:
 *   post:
 *     summary: Purchase a data bundle using wallet balance
 *     description: >
 *       coded encodes the provider as its prefix (e.g. "mtn_1gb-30days").
 *       Validates the number via MCD, deducts reseller_price from wallet,
 *       calls MCD's /data endpoint, and rolls back the wallet on failure.
 *     tags: [Data]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *           schema:
 *             type: object
 *             required: [coded, number, reseller_price]
 *             properties:
 *               coded:
 *                 type: string
 *                 description: Provider-prefixed plan code, e.g. "mtn_1gb-30days"
 *                 example: "mtn_1gb-30days"
 *               number:
 *                 type: string
 *                 example: "08012345678"
 *               reseller_price:
