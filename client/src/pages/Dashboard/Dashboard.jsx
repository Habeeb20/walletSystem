...
//     <div className="text-gray-700 text-lg">Welcome back, <span className="text-black font-bold">{useSelector((state) => state.auth.dashboardData?.user?.fullName || '')}</span></div>
...
//         <div className="text-sm text-green-100 font-bold"> {dashboardData?.user?.fullName }</div>
...
//         <nav className="mt-2">
//           <a href="#" onClick={() => handleNavigation(<Dashboard1 />)} className="block py-2.5 px-4 text-green-800 bg-green-200 rounded-l-lg flex items-center"><span className="mr-2">🏠</span>Dashboard</a>
...
//       {/* Main Content */}
//       <div className="flex-1 ml-0 md:ml-64 p-6 overflow-y-auto ml-4 md:ml-4 pt-16 md:pt-16">
//         {content}
