...
import TransactionHistory from '../SideBars/TransactionHistory';
import HelpSupport from '../SideBars/HelpSupport';
...
const Helpsupport = () => <div><HelpSupport /></div>;
      ...
      >
        <nav className="mt-2">
          ...
          <a
            ...
            className={activeMenu === 'Transactions' ? activeClasses : baseClasses}
          >
