...
function DashboardContent({ handleMenuClick }) { // Receive handleMenuClick as prop
  ...
  const totalBalance = (walletBalance || walletBalanceFromData) + virtualBalance;
...
// FILTER OUT ZERO-AMOUNT TRANSACTIONS
  const nonZeroTransactions = allTransactions.filter((t) => t.amount > 0);

  const income = nonZeroTransactions
    .filter((t) => t.type === 'credit')
    .reduce((sum, t) => sum + t.amount, 0) || 0;

  const expenses = nonZeroTransactions
    .filter((t) => t.type === 'debit')
    .reduce((sum, t) => sum + t.amount, 0) || 0;

  // Use filtered transactions for recent/activity display
  const recentTransactions = nonZeroTransactions
    ...
    <div>
      <div className="p-6 pt-10 md:pt-4">
            ...
            <div>
              ...
              {checkBalanceData && (
                <div className="mt-4 bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700">Account: {checkBalanceData.dva_account_number}</p>
                  <p className="text-gray-700">Last Updated: {checkBalanceData.last_updated}</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              {/* <button
                className="bg-purple-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
                onClick={() => {
              ...
              <button
                ...
                className="bg-orange-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Transfer</span>
              </button>
              <button
                onClick={() => handleMenuClick(<AirtimePage />, 'Airtime')}
                className="bg-blue-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Airtime</span>
              </button>
              <button
                onClick={() => handleMenuClick(<DataPage />, 'Data')}
                className="bg-pink-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Data</span>
              </button>
              <button
                onClick={() => handleMenuClick(<ElectricityPage />, 'Electricity')}
                className="bg-green-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Electricity</span>
              </button>
              <button
                onClick={() => handleMenuClick(<TvSubscriptionPage />, 'Cable TV')}
                className="bg-blue-600 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Cable TV</span>
              </button>
              <button
                onClick={() => handleMenuClick(<TransactionHistory allTransactions={allTransactions} />, 'Transactions')}
                className="bg-yellow-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
              ...
              {/* <button
                ...
                className="bg-teal-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Bulk SMS</span>
              </button>
              <button
                onClick={() => handleMenuClick(<div>Result Checker Component</div>, 'Result Checker')}
                className="bg-indigo-500 text-white p-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center h-16 w-full cursor-pointer"
              >
                <span className="text-lg">Result Checker</span>
              </button> */}
            </div>
            {showFundingForm && (
              <div className="mt-4">
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          <div
            onClick={() => handleMenuClick(<AirtimePage />, 'Airtime')}
            className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center text-center h-32 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
          ...
          {/* <div
            onClick={() => handleMenuClick(<div>Airtime to Cash Component</div>, 'Airtime to Cash')}
            className="bg-gradient-to-r from-green-900 to-green-700 text-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center text-center h-32 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
