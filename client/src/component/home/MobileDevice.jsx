...
const MobileDevice = () => {
  return (
    <div className="relative w-[330px] h-[580px] bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-green-700">
      {/* Header */}
      <div className="flex justify-between items-center p-2 bg-green-700 text-white text-sm">
        <span>Dashboard</span>
        <span>Olurotimi Stephen</span>
      ...
      <div className="p-4 text-center">
        {/* Total Balance Card */}
        <div className="bg-green-600 text-white rounded-xl p-4 mb-4 flex justify-between items-center">
          <div>
            <div className="text-sm font-bold">Total Balance</div>
            <div className="text-2xl font-semibold mt-1">NGN 0.00</div>
          </div>
          <span className="text-yellow-400 text-2xl">💰</span>
        </div>

        {/* Income Card */}
        <div className="bg-green-100 text-green-800 rounded-xl p-4 mb-4 flex justify-between items-center">
          <div>
            <div className="text-sm font-bold">Income</div>
            <div className="text-lg font-semibold mt-1">NGN 0.00</div>
          </div>
          <span className="text-blue-400">⬆</span>
        </div>

        {/* Expenses Card */}
        <div className="bg-red-100 text-red-800 rounded-xl p-4 mb-4 flex justify-between items-center">
          <div>
        ...
        <div className="mb-4">
          <div className="text-sm font-bold text-gray-800 mb-2">Quick Actions</div>
          <div className="grid grid-cols-2 gap-2">
            <button className="bg-purple-500 text-white py-2 rounded-lg shadow-md hover:bg-purple-600 transition-colors duration-200">
              Add Money
            </button>
            <button className="bg-orange-500 text-white py-2 rounded-lg shadow-md hover:bg-orange-600 transition-colors duration-200">
              Transfer
            </button>
            <button className="bg-blue-500 text-white py-2 rounded-lg shadow-md hover:bg-blue-600 transition-colors duration-200">
              Airtime
            </button>
            <button className="bg-pink-500 text-white py-2 rounded-lg shadow-md hover:bg-pink-600 transition-colors duration-200">
              Data
            </button>
            <button className="bg-green-500 text-white py-2 rounded-lg shadow-md hover:bg-blue-600 transition-colors duration-200">
              cable payment
            </button>
            <button className="bg-yellow-500 text-white py-2 rounded-lg shadow-md hover:bg-pink-600 transition-colors duration-200">
              Result checker
            </button>
          </div>
        </div>
